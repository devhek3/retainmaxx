  ...
  return (
    <ScrollView accessibilityLabel="All saved videos" contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      >
        ...
        <AppText style={styles.backButtonText}>Library</AppText>
      </Pressable>
      <AppText accessibilityRole="header" fontRole="display" style={styles.title}>All saved videos</AppText>
      <AppText style={styles.description}>Your complete knowledge library.</AppText>
...
const styles = StyleSheet.create({
  ...
  backButtonText: { color: colors.primary, fontSize: 14, fontWeight: fontWeights.semibold },
  title: { color: colors.text, fontSize: 28, fontWeight: fontWeights.bold, letterSpacing: -0.7, marginTop: 18 },
